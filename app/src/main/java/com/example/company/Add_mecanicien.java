...
allApi.addPerson(person).enqueue(new Callback<Person>() {
    ...
    public void onResponse(Call<Person> call, Response<Person> response) {
        Toast.makeText(Add_mecanicien.this, "get mecanicien successfully", Toast.LENGTH_SHORT).show();
    }

    @Override
    public void onFailure(Call<Person> call, Throwable t) {
        Toast.makeText(Add_mecanicien.this, "failed to get mecanicien", Toast.LENGTH_SHORT).show();
    }
});
        });
